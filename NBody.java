...
public class NBody{
  ...
  public static final double tmax = 8765.82*10*3.54;                  //number of hours to run
  ...
  // public static SolarBody body2 = SolarBody.other("satellite", 100, SolarBody.au/7, SolarBody.vJupiter, 0.001, 3*Math.PI/2);
