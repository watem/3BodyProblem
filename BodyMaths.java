public class BodyMaths {
  public static final double G = 8.64960768*Math.pow(10, -13); // actual value
  ...
  // public static double accelUpdate(double obj[][][],double body[][],double bodyMass,int i,double dt){
  //   obj[2][0][i]
  // }//accelUpdate()
